...
typedef struct
{
    uint8_t usart_tx_reserved : 5;                                /* @Brief : USART Transmit Reserved Bits. */
    uint8_t usart_enable_tx : 1;                                  /* @Brief : USART Enabling  or Disabling Transmit configuration. */
    uint8_t usart_enable_tx_interrupt : 1;                        /* @Brief : USART Transmit Interrupt configuration. */
    uint8_t usart_enable_9bit_tx : 1;                             /* @Brief : USART Enabling or Disabling 9-Bit Transmission configuration. */
...
typedef struct
{   
    uint8_t usart_rx_reserved : 5;                                /* @Brief : USART Receive Reserved Bits. */
    uint8_t usart_enable_rx : 1;                                  /* @Brief : USART Enabling  or Disabling Receive configuration. */
    uint8_t usart_enable_rx_interrupt : 1;                        /* @Brief : USART Receive Interrupt configuration. */
    uint8_t usart_enable_9bit_rx : 1;                             /* @Brief : USART Enabling or Disabling 9-Bit Receiving configuration. */
...
typedef union 
{
    struct
    {
        uint8_t usart_tx_reserved : 6;                        /* @Brief : USART Error Status Reserved Bits. */  
        uint8_t usart_ferr : 1;                               /* @Brief : USART Framing Error configuration. */
        uint8_t usart_oerr : 1;                               /* @Brief : USART Overrun Error configuration. */  
    };
    uint8_t status;
...
typedef struct 
{
    uint32_t baudrate;                                        /* @Brief : USART Baud Rate configuration. */
