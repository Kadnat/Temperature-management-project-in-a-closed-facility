...
typedef struct
{
    ...
    uint16_t timer0_preload_value;                        /* @Brief : Timer0 Pre-load configuration. */
    uint8_t prescaler_status_cfg  : 1;                    /* @Brief : Timer0 Pre-scaler status configuration. */
    uint8_t timer0_counter_edge : 1;                      /* @Brief : Timer0 Counter Mode Edge Type configuration. */
    uint8_t timer0_mode : 1;                              /* @Brief : Timer0 Mode configuration. */
    uint8_t timer0_register_size : 1;                     /* @Brief : Timer0 Register Size Selection configurations. */
    uint8_t timer0_reserved : 4;                          /* @Brief : Timer0 Reserved Bits. */
}timer0_t;
/***********************************************************************/
