...
#endif
    uint16_t timer1_preload_value;                /* @Brief : Timer1 Pre-load configuration. */
    uint8_t timer1_prescaler_value : 2;           /* @Brief : Timer1 Pre-scaler configuration. */
    uint8_t timer1_mode : 1;                      /* @Brief : Timer1 Mode configuration. */
    uint8_t timer1_counter_mode : 1;              /* @Brief : Timer1 Counter Mode configuration. */
    uint8_t timer1_osc_cfg : 1;                   /* @Brief : Timer1 Oscillator configuration. */
    uint8_t timer1_reg_rw_mode : 1;               /* @Brief : Timer1 R/W configuration. */
    uint8_t timer1_reserved : 2;                  /* @Brief : Timer1 Reserved Bits. */
}timer1_t;
/***********************************************************************/
