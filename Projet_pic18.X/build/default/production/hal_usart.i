...
static void USART_Baud_Rate_Calculation(const usart_t *_usart)
{
    ...
    switch(_usart->baudrate_config)
    {
        case BAUDRATE_ASYNCHRONOUS_MODE_8BIT_LOW_SPEED :
            ...
            TXSTAbits.BRGH = 0;
            BAUDCONbits.BRG16 = 0;
            Baud_Rate_Temp_Value = ((4000000 / (float)_usart->baudrate) / 64) - 1;
        break;
        ...
        case BAUDRATE_ASYNCHRONOUS_MODE_8BIT_HIGH_SPEED :
            ...
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 0;
            Baud_Rate_Temp_Value = ((4000000 / (float)_usart->baudrate) / 16) - 1;
        break;
        ...
        case BAUDRATE_ASYNCHRONOUS_MODE_16BIT_HIGH_SPEED :
            ...
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 1;
            Baud_Rate_Temp_Value = ((4000000 / (float)_usart->baudrate) / 4) - 1;
        break;
