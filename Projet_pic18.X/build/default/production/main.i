...
# 5 "C:/Users/natha/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\\pic\\include\\builtins.h" 2 3
...
typedef struct
{
    ...
    uint8_t prescaler_status_cfg : 1;
...
# 105 "./hal_timer0.h"
uint8_t Timer0_Init(const timer0_t *_timer);
# 114 "./hal_timer0.h"
uint8_t Timer0_DeInit(const timer0_t *_timer);
# 124 "./hal_timer0.h"
...
void execute_rx_command(int command_index) {
    ...
    switch (command_index) {
        ...
        {
            float temperature = strtof(rx_buffer + strlen(commands[2]),0);
...
void usart_module_init(void)
{
    ...
    usart_obj.usart_tx_cfg.usart_enable_tx = 1;
    usart_obj.usart_tx_cfg.usart_enable_tx_interrupt = 1;
    usart_obj.usart_tx_cfg.usart_enable_9bit_tx = 0;

    usart_obj.usart_rx_cfg.usart_enable_rx = 1;
    usart_obj.usart_rx_cfg.usart_enable_rx_interrupt = 1;
    usart_obj.usart_rx_cfg.usart_enable_9bit_rx = 0;
